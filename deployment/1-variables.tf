...
/* cidr is to assing ip adressess to vpc */
...
/* public subnet allow internet access to whatever is hosted */
...
/* private public internet access to it */
...
/* Allow internet accesse from all IP's */
